...
class VolumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volume" do
    assert_difference('Volume.count') do
      post volumes_url, params: { volume: { description: @volume.description, title: @volume.title } }
    end
  ...
  test "should update volume" do
    patch volume_url(@volume), params: { volume: { description: @volume.description, title: @volume.title } }
